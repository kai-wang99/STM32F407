...
C_SRCS += \
../system/src/stm32f4xx/Legacy/stm32f4xx_hal_can.c 

OBJS += \
./system/src/stm32f4xx/Legacy/stm32f4xx_hal_can.o 

C_DEPS += \
./system/src/stm32f4xx/Legacy/stm32f4xx_hal_can.d 


# Each subdirectory must supply rules for building sources it contributes
system/src/stm32f4xx/Legacy/%.o: ../system/src/stm32f4xx/Legacy/%.c
	@echo 'Building file: $<'

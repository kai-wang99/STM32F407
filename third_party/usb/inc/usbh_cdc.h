...
#define USB_CDC_CLASS                                           0xff//0x02 kai
#define COMMUNICATION_INTERFACE_CLASS_CODE                      0xff//0x02 kai

/*Data Interface Class Codes*/
#define DATA_INTERFACE_CLASS_CODE                               0xff//0x0A kai

/*Communication sub class codes*/
#define RESERVED                                                0x00
#define DIRECT_LINE_CONTROL_MODEL                               0x01
#define ABSTRACT_CONTROL_MODEL                                  0xff//0x02 kai
...
#define COMMON_AT_COMMAND                                       0xff//0x01 kai
